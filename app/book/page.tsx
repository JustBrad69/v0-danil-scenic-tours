...
const EMAILJS_SERVICE_ID = 'service_ay2nv0k'
const EMAILJS_TEMPLATE_ID = 'template_e49zmdo'
const EMAILJS_PUBLIC_KEY = 'z65mcdoYN8jQN7waf'
...
export default function BookPage() {
  ...
  const totalTravelers = form.adults + form.teens + form.children + form.infants
            ...
            {step === 2 && (
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-[#FAF4E8] rounded-xl p-4">
                      ...
                      <div className="flex items-center gap-3">
                        <button onClick={() => update('adults', Math.max(1, form.adults - 1))} className="w-8 h-8 rounded-full bg-white border border-gray-200 flex items-center justify-center hover:border-[#D4870A] transition-all">
                        ...
                        <button onClick={() => update('adults', form.adults + 1)} className="w-8 h-8 rounded-full bg-white border border-gray-200 flex items-center justify-center hover:border-[#D4870A] transition-all">
                    ...
                    <div className="bg-[#FAF4E8] rounded-xl p-4">
                      ...
                      <div className="flex items-center gap-3">
                        <button onClick={() => update('teens', Math.max(0, form.teens - 1))} className="w-8 h-8 rounded-full bg-white border border-gray-200 flex items-center justify-center hover:border-[#D4870A] transition-all">
                          <Minus size={14} className="text-[#1C1208]" />
                        </button>
                        <span className="font-montserrat font-bold text-xl text-[#2A4A35] w-8 text-center">{form.teens}</span>
                        <button onClick={() => update('teens', form.teens + 1)} className="w-8 h-8 rounded-full bg-white border border-gray-200 flex items-center justify-center hover:border-[#D4870A] transition-all">
                          <Plus size={14} className="text-[#1C1208]" />
                        </button>
                      </div>
                    </div>
                    ...
                    <div className="bg-[#FAF4E8] rounded-xl p-4">
                      ...
                      <div className="flex items-center gap-3">
                        <button onClick={() => update('children', Math.max(0, form.children - 1))} className="w-8 h-8 rounded-full bg-white border border-gray-200 flex items-center justify-center hover:border-[#D4870A] transition-all">
                          <Minus size={14} className="text-[#1C1208]" />
                        </button>
                        <span className="font-montserrat font-bold text-xl text-[#2A4A35] w-8 text-center">{form.children}</span>
                        <button onClick={() => update('children', form.children + 1)} className="w-8 h-8 rounded-full bg-white border border-gray-200 flex items-center justify-center hover:border-[#D4870A] transition-all">
                          <Plus size={14} className="text-[#1C1208]" />
                        </button>
                      </div>
                    </div>
                    ...
                    <div className="bg-[#FAF4E8] rounded-xl p-4">
                      ...
                      <div className="flex items-center gap-3">
                        <button onClick={() => update('infants', Math.max(0, form.infants - 1))} className="w-8 h-8 rounded-full bg-white border border-gray-200 flex items-center justify-center hover:border-[#D4870A] transition-all">
                          <Minus size={14} className="text-[#1C1208]" />
                        </button>
                        <span className="font-montserrat font-bold text-xl text-[#2A4A35] w-8 text-center">{form.infants}</span>
                        <button onClick={() => update('infants', form.infants + 1)} className="w-8 h-8 rounded-full bg-white border border-gray-200 flex items-center justify-center hover:border-[#D4870A] transition-all">
                          <Plus size={14} className="text-[#1C1208]" />
                        </button>
                      </div>
                    </div>
                ...
                <div className="flex gap-3">
                  <button onClick={prevStep} className="w-1/3 py-4 border-2 border-[#2A4A35] text-[#2A4A35] font-montserrat font-semibold rounded-lg hover:bg-[#2A4A35] hover:text-white transition-all flex items-center justify-center gap-2">
                    <ChevronLeft size={18} /> Back
                  </button>
                  <button onClick={nextStep} className="w-2/3 py-4 bg-[#D4870A] text-[#1C1208] font-montserrat font-semibold rounded-lg hover:shadow-lg transition-all flex items-center justify-center gap-2">
            ...
            {step === 3 && (
              <div className="space-y-6">
                ...
                <div className="flex gap-3">
                  ...
                  <button onClick={handleSubmit} className="w-2/3 py-4 bg-[#D4870A] text-[#1C1208] font-montserrat font-semibold rounded-lg hover:shadow-lg transition-all flex items-center justify-center gap-2">
              ...
              <div className="space-y-6">
                ...
                {sendError && (
                  <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                    <p className="font-inter text-red-600 text-sm text-center">
                      Something went wrong sending your inquiry. Please try again or use the contact options below.
                    </p>
                  </div>
                )}
                ...
                <button
                  ...
                  disabled={sending}
                  className="w-full py-4 bg-[#D4870A] text-[#1C1208] font-montserrat font-semibold rounded-lg hover:shadow-lg transition-all flex items-center justify-center gap-2 text-base disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {sending ? (
                    <>
                ...
                <p className="text-xs text-[#1C1208] opacity-60 font-inter text-center">
                  Your inquiry will be sent directly to our team. We respond within 2 hours during business hours.
                </p>
              </div>
            )}
